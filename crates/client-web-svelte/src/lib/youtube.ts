// YouTube helper — URL extraction + IFrame API loader.
// Ported from vanilla client-web/src/app/youtube.ts (115 lines) as-is.
// No Svelte-specific concerns; pure DOM + URL parsing.

import type { YouTubeIframeApi } from './playerTypes';
