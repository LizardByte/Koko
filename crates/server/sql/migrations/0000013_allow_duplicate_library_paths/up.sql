...
INSERT INTO item_metadata_people (
    id,
    metadata_link_id,
    external_id,
    name,
...
INSERT INTO item_metadata_collections (
    id,
    metadata_link_id,
    provider_id,
    external_id,
...
SELECT
    ...
    provider_payload_json,
    updated_at
FROM item_metadata_collections_old;
