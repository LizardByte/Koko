...
<Story name="Movie" args={{ preset: 'home', route: '/' }}>
  <MediaCard item={movieSummary()} />
</Story>

<Story name="Show" args={{ preset: 'home', route: '/' }}>
  <MediaCard item={showSummary()} />
</Story>

<Story name="Season" args={{ preset: 'home', route: '/' }}>
  <MediaCard item={seasonSummary()} />
</Story>

<Story name="Episode" args={{ preset: 'home', route: '/' }}>
  <MediaCard item={episodeSummary()} />
</Story>

<Story name="Track" args={{ preset: 'home', route: '/' }}>
...
-->
<Story name="Unmatched" args={{ preset: 'home', route: '/' }}>
  <MediaCard item={trackSummary()} />
</Story>

<!-- Watched: watch_count > 0 → checkmark badge, title "Watched Nx" -->
<Story name="Watched" args={{ preset: 'home', route: '/' }}>
...
<Story name="In Progress" args={{ preset: 'home', route: '/' }}>
  <MediaCard
    item={movieSummary({
