// Media extras helpers — display labels + trailer-option conversion.
// Ported from vanilla client-web/src/app/mediaExtras.ts (33 lines) as-is.
// Pure functions, no Svelte/DOM concerns.

import type { MediaItemExtra } from './api';
import { formatMediaTime } from './format';
import type { TrailerOption } from './playerTypes';
